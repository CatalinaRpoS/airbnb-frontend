           ...
           <div className="relative">
                ...
                {showArrows && (
                    <div className="absolute top-0 left-6 right-6 bottom-20 flex justify-between items-center">
                        <button className="text-black text-lg h-7 w-7 rounded-full bg-white flex justify-center items-center" onClick={prevImage}>
                            <img className="h-3 w-3" src={arrowl} alt="" />
                        </button>
                        <button className="text-black text-lg h-7 w-7 rounded-full bg-white flex justify-center items-center" onClick={nextImage}>
